...
- The `xdg.portal.gtkUsePortal` option has been removed due to deprecation. Consider not setting the variable or set `GTK_USE_PORTAL`  yourself via `environment.sessionVariables`.
